...
export default function ProtocolSimulator() {
  const [activeEvent, setActiveEvent] = useState<typeof SCENARIOS[0] | null>(null);
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-end mb-12">
        <div>
          <h1 className="text-4xl font-black tracking-tighter uppercase italic">
            Protocol Simulator <span className="text-xs border px-2 py-1 rounded ml-2">v1.0.4</span>
          </h1>
